...
public class Mapper extends GUI {
	...
	protected void findMST() {
		mstS mst = new mstS();
		mst.kruskalsAlgorithm();
		getTextOutputArea().setText((mst.tree.size() + " MST Edges"));
	}
	...
	protected void onClick(MouseEvent e) {
		...
		if (clicked.distance(closest.location) < MAX_CLICKED_DISTANCE) {
			findAP search = new findAP();
			Set<Node> tempSet = search.findArt();
			graph.setHighlightedAP(tempSet);
			getTextOutputArea().setText((tempSet.size()) + " Articulation Points Found");
		}
	}
